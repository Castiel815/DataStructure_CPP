//
// Created by CY815 on 2023/6/17.
//

#ifndef DATASTRUCTURE_MYEXCEPTIONS_H
#define DATASTRUCTURE_MYEXCEPTIONS_H
...
public:
    matrixIndexOutOfBounds
            (std::string theMessage = "Matrix index out of bounds") { message = theMessage; }
...
#endif //DATASTRUCTURE_MYEXCEPTIONS_H
