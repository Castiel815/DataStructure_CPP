...
#ifndef DATASTRUCTURE_FASTUNIONFIND_H
#define DATASTRUCTURE_FASTUNIONFIND_H
...
class fastUnionFind {
public:
    explicit fastUnionFind(int numberOfElements) {// Initialize numberOfElements trees, 1 element per set/class/tree.
...
#endif //DATASTRUCTURE_FASTUNIONFIND_H
